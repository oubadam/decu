...
function F(e) {
    ...
    return P.has(t) ? !0 : (P.add(t), !1)
}

function q(e) {
    for (const t of e.scripts) !t.hasAttribute("data-astro-rerun") && F(t) && (t.dataset.astroExec = "")
}
...
function j(e, t) {
    ...
    for (const n of t.querySelectorAll(`[${b}]`)) {
        ...
        r && (r.replaceWith(n), r.localName === "astro-island" && K(n) && !z(n, r) && (n.setAttribute("ssr", ""), n.setAttribute("props", r.getAttribute("props"))))
    }
}
const U = () => {
    ...
    z = (e, t) => e.getAttribute("props") === t.getAttribute("props"),
    G = e => {
        q(e), B(e), W(e);
        const t = U();
        j(e.body, document.body), t()
    },
    J = "astro:before-preparation",
    Q = "astro:after-preparation",
    Z = "astro:before-swap",
    ee = "astro:after-swap",
    te = e => document.dispatchEvent(new Event(e));
class O extends Event {
    ...
    newDocument;
    signal;
    constructor(t, n, o, r, i, u, a, l, d, c) {
        super(t, n), this.from = o, this.to = r, this.direction = i, this.navigationType = u, this.sourceElement = a, this.info = l, this.newDocument = d, this.signal = c, Object.defineProperties(this, {
            from: {
                enumerable: !0
            },
            to: {
...
class ne extends O {
    ...
    constructor(t, n, o, r, i, u, a, l, d, c) {
        super(J, {
            cancelable: !0
        }, t, n, o, r, i, u, a, l), this.formData = d, this.loader = c.bind(this, this), Object.defineProperties(this, {
            formData: {
                enumerable: !0
            },
            loader: {
...
class oe extends O {
    ...
    swap;
    constructor(t, n) {
        super(Z, void 0, t.from, t.to, t.direction, t.navigationType, t.sourceElement, t.info, t.newDocument, t.signal), this.direction = t.direction, this.viewTransition = n, this.swap = () => G(this.newDocument), Object.defineProperties(this, {
            direction: {
                enumerable: !0
            },
            viewTransition: {
...
async function re(e, t, n, o, r, i, u, a, l) {
    const d = new ne(e, t, n, o, r, i, window.document, u, a, l);
    return document.dispatchEvent(d) && (await d.loader(), d.defaultPrevented || (te(Q), d.navigationType !== "traverse" && R({
        scrollX,
        scrollY
    }))), d
}
...
const ie = history.pushState.bind(history),
    v = history.replaceState.bind(history),
    R = e => {
        history.state && (history.scrollRestoration = "manual", v({ ...history.state,
            ...e
        }, ""))
    },
    M = !!document.startViewTransition,
    x = () => !!document.querySelector('[name="astro-view-transitions-enabled"]'),
    H = (e, t) => e.pathname === t.pathname && e.search === t.search;
let f, p, g;
const X = e => document.dispatchEvent(new Event(e)),
    ...
    I = "data-astro-transition",
    S = "data-astro-transition-fallback";
let L, T = 0;
history.state ? (T = history.state.index, scrollTo({
...
const C = (e, t, n, o, r) => {
    ...
    if (document.title = u, g = e, i || (scrollTo({
            left: 0,
            top: 0,
            behavior: "instant"
        ...
        if (e.hash) {
            ...
            const l = history.state;
            location.href = e.href, history.state || (v(l, ""), i && window.dispatchEvent(new PopStateEvent("popstate")))
        } else a || scrollTo({
            left: 0,
            top: 0,
            behavior: "instant"
...
function ue(e) {
    ...
    for (const n of e.querySelectorAll("head link[rel=stylesheet]"))
        if (!document.querySelector(`[${D}="${n.getAttribute(D)}"], link[rel=stylesheet][href="${n.getAttribute("href")}"]`)) {
...
async function k(e, t, n, o, r) {
    ...
    const u = document.title,
        a = se(e, n.viewTransition);
    C(a.to, a.from, t, u, o), X(ee), r === "animate" && (!n.transitionSkipped && !a.signal.aborted ? i("new").finally(() => n.viewTransitionFinished()) : n.viewTransitionFinished())
}

function de() {
    return f?.controller.abort(), f = {
...
async function $(e, t, n, o, r) {
    ...
    if (u !== "traverse" && R({
            scrollX,
            scrollY
        }), H(t, n) && (e !== "back" && n.hash || e === "back" && t.hash)) {
        C(n, t, o, document.title, r), i === f && (f = void 0);
        return
    }
    const a = await re(t, n, e, u, o.sourceElement, o.info, i.controller.signal, o.formData, l);
    ...
    async function l(s) {
        ...
        if (s.formData) {
            ...
            h.body = t !== void 0 && Reflect.get(HTMLFormElement.prototype, "attributes", y).getNamedItem("enctype")?.value === "application/x-www-form-urlencoded" ? new URLSearchParams(s.formData) : s.formData
        }
        const m = await ce(w, h);
        if (m === null) {
            s.preventDefault();
            return
        }
        ...
        if (L??= new DOMParser, s.newDocument = L.parseFromString(m.html, m.mediaType), s.newDocument.querySelectorAll("noscript").forEach(y => y.remove()), !s.newDocument.querySelector('[name="astro-view-transitions-enabled"]') && !s.formData) {
            s.preventDefault();
            return
        }
        const A = ue(s.newDocument);
    ...
    if (document.documentElement.setAttribute(I, a.direction), M) c.viewTransition = document.startViewTransition(async () => await k(a, o, c, r));
    else {
        const s = (async () => {
            await Promise.resolve(), await k(a, o, c, r, _())
        })();
        c.viewTransition = {
    ...
    c.viewTransition?.updateCallbackDone.finally(async () => {
        ...
        c.viewTransition = void 0, c === p && (p = void 0), i === f && (f = void 0), document.documentElement.removeAttribute(I), document.documentElement.removeAttribute(S)
    });
    try {
...
async function me(e, t) {
    await $("forward", g, new URL(e, location.href), t?? {})
}
...
function fe(e) {
    ...
    const t = history.state,
        n = t.index,
        o = n > T ? "forward" : "back";
    T = n, $(o, g, new URL(location.href), {}, t)
}
const N = () => {
    ...
    if (M || _() !== "none")
        if (g = new URL(location.href), addEventListener("popstate", fe), addEventListener("load", Y), "onscrollend" in window) addEventListener("scrollend", N);
        else {
            let e, t, n, o;
            const r = () => {
    ...
    for (const e of document.getElementsByTagName("script")) F(e), e.dataset.astroExec = ""
}
export {
    me as n, M as s
};